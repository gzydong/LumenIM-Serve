...
class Rsa
{
    ...
    {
        return openssl_pkey_get_private(file_get_contents(base_path('rsa/rsa_private_key.pem')));
    }
    ...
    {
        return openssl_pkey_get_public(file_get_contents(base_path('rsa/rsa_public_key.pem')));
    }
