...
class CreateLumenimTables extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        Schema::drop('article');
        Schema::drop('article_annex');
        Schema::drop('article_class');
        Schema::drop('article_detail');
        Schema::drop('article_tags');
        Schema::drop('emoticon');
        Schema::drop('emoticon_details');
        Schema::drop('file_split_upload');
        Schema::drop('user_login_log');
        Schema::drop('users');
        Schema::drop('users_chat_files');
        Schema::drop('users_chat_list');
        Schema::drop('users_chat_records');
        Schema::drop('users_emoticon');
        Schema::drop('users_friends');
        Schema::drop('users_friends_apply');
        Schema::drop('users_group');
        Schema::drop('users_group_member');
    }
}
